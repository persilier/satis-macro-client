                    ...
                    if (result.value) {
                        axios.delete(`${appConfig.apiDomaine}/claim-categories/${claimCategoryId}`)
                            .then(response => {
                                ...
                                setNumberPage(forceRound(newClaimCategories.length/numberPerPage));
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12 col-md-5">
                                                    <div className="dataTables_info" id="kt_table_1_info" role="status"
                                                         aria-live="polite">{t("Affichage de")} 1 {t("à")} {numberPerPage} {t("sur")} {claimCategories.length} {t("données")}
                                                    </div>
                                                </div>
                                                {
                                                    showList.length ? (

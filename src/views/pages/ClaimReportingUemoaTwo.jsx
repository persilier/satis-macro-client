    ...
    const downloadReportingPdf = async () => {
        ...
        if (verifyTokenExpire()) {
            await axios({
                ...
                .then(async ({data}) => {
                    setError(defaultError);
                    FileSaver.saveAs(data, `reporting_retard_30_jours_${new Date().getFullYear()}.pdf`);
                    setLoadDownload(false);
                    // ToastBottomEnd.fire(toastSuccessMessageWithParameterConfig('Téléchargement éffectuer avec succès'));
                })
                .catch(error => {
            ...
            <tr key={index} role="row" className="odd">
                <td>
                    ...
                    <div className="dropdown-menu px-5" style={{ width: "550px" }}>
                        ...
                        <div className="d-flex justify-content-between">
                            <strong>{t("Délai de traitement")} (J) {t("avec weekend")}</strong>
                ...
                <div className="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                    ...
                    <div className="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                        <InfirmationTable information={(
                            <div>
                                {t("État complet de toutes les réclamations qui ont déjà fait plus de 30 jours et qui n'ont toujours pas encore été traitées à la date du jour")}.
                            </div>
                        )}/>

                        <div className="kt-portlet">
                            <HeaderTablePage
                                title={t("Rapport") + " " + t("État retard de") + " 30 " + t("jours")}
                            />

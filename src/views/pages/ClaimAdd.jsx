...
const ClaimAdd = (props) => {
  ...
  document.title =
    "Satis client - " + ready ? t("Enrégistrement de réclamation") : "";
  if (
    !(
      verifyPermission(
      ...
      await axios
        ...
        .then((response) => {
          ...
          if (
            ...
            setUnits(
              formatSelectOption(
                response.data.units || response.data.institutions,
                "name",
                verifyPermission(
                  props.userPermissions,
                  "store-claim-against-any-institution"
    ...
    if (selected) {
      ...
      if (
        ...
        if (verifyTokenExpire()) {
          axios
            .get(
              `${appConfig.apiDomaine}/institutions/${selected.value}/clients`
            )
            .then((response) => {
  ...
  const searchClient = () => {
    if (searchInputValue.length) {
      ...
      ToastBottomEnd.fire(
        toastErrorMessageWithParameterConfig(
          t("Veuillez renseigner le champ de recherche")
        )
      );
    }
  };
  ...
  return load || !ready ? (
    ...
    >
      ...
      <div className="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <InfirmationTable
          information={
            componentData ? componentData.params.fr.info_page.value : ""
          }
        />
        <div className="row">
          <div className="col">
            <div className="kt-portlet">
                ...
                <div className="kt-portlet__head-toolbar">
                  <div className="kt-portlet__head-wrapper">
                    ...
                    <div className="dropdown dropdown-inline">
                      <InfoFormatExcel />
                      <a
                        href={`${appConfig.apiDomaine}/download-excel/claims`}
                        download={true}
                        className="btn mr-1 btn-secondary"
                      >
                        {" "}
                        {componentData
                          ? componentData.params.fr.telecharger.value
                          : ""}
                      </a>
                      <NavLink
                        to={"/process/claims/import"}
                        className="btn ml-1 btn-primary"
                      >
                        {" "}
                        {componentData
                          ? componentData.params.fr.importer.value
                          : ""}
                      </NavLink>
                    </div>
                  </div>
                    ...
                    >
                      ...
                      <div className="col-lg-9 col-xl-6">
                        <Select
                          ...
                          placeholder={
                            componentData
                              ? componentData.params.fr.institution_placeholder
                                  .value
                              : ""
                          }
                          ...
                          >
                            ...
                            {accounts.length ? (
                              <Select
                                ...
                                placeholder={
                                  componentData
                                    ? componentData.params.fr.compte_placeholder
                                        .value
                                    : ""
                                }
                      ...
                      <div className="form-group row">
                        ...
                        >
                          ...
                          <Select
                            ...
                            placeholder={
                              componentData
                                ? componentData.params.fr.categorie_placeholder
                                    .value
                                : ""
                            }
                            value={claimCategory}
                        ...
                        >
                          ...
                          <input
                            ...
                            placeholder={
                              componentData
                                ? componentData.params.fr.lieu_placeholder.value
                                : ""
                            }
                            value={data.lieu}
                      ...
                      <div className="form-group row">
                        ...
                        >
                          ...
                          <input
                            ...
                            placeholder={
                              componentData
                                ? componentData.params.fr.date_placeholder.value
                                : ""
                            }
                        ...
                        {verifyPermission(
                          ...
                          >
                            ...
                            <Select
                              ...
                              placeholder={
                                componentData
                                  ? componentData.params.fr.relation_placeholder
                                      .value
                                  : ""
                              }
                          ...
                          <div className="col-12">
                            ...
                            >
                              ...
                              <div className="alert-text">
                                <p>
                                  {t(
                                    "La réclamation a été enregistrée avec succès sous la référence"
                                  )}
                                ...
                                <p>
                                  {t(
                                    "Les informations qu'il reste à fournir sont les suivantes"
                                  )}{" "}
                                  :
                                </p>
                                <ul className="ml-4">
              ...
              {foundData.entity ? (
                <ConfirmClaimAddModal
                  ...
                  firstname={
                    foundData.entity.firstname ? foundData.entity.firstname : ""
                  }
                  lastname={
                  ...
                  account_targeted_id={
                    data.account_targeted_id ? data.account_targeted_id : ""
                  }
                  account_number={
                    data.account_number ? data.account_number : ""
                  }
                  claim_object_id={
                    data.claim_object_id ? data.claim_object_id : ""
                  }
                  request_channel_slug={
                    data.request_channel_slug ? data.request_channel_slug : ""
                  }
                  response_channel_slug={
                    data.response_channel_slug ? data.response_channel_slug : ""
                  }
                  claimer_expectation={
                    data.claimer_expectation ? data.claimer_expectation : ""
                  }
                  description={data.description ? data.description : ""}
                  amount_currency_slug={
                    data.amount_currency_slug ? data.amount_currency_slug : ""
                  }
                  amount_disputed={
                    data.amount_disputed ? data.amount_disputed : ""
                  }
                  claimer_id={data.claimer_id ? data.claimer_id : ""}
                  relationship_id={
                    data.relationship_id ? data.relationship_id : ""
                  }
                  event_occured_at={
                    data.event_occured_at ? data.event_occured_at : ""
                  }

...
import AddCategoryFaq from "../../views/components/AddCategoryFaq";
import {Link} from "react-router-dom";

const FaqCategoryDataTable=()=>{
    ...
    const onDeleted=(elemt)=>{
        axios.delete(`http://127.0.0.1:8000/faq-categories/${elemt}`
        )
                            ...
                            <table className="kt-datatable__table" style={{display: 'block'}}>
                                ...
                                <tr className="kt-datatable__row" style={{left: "0px"}}>
                                    ...
                                    <th data-field="ShipDate"
                                        className="kt-datatable__cell kt-datatable__cell--sort"><span
                                        style={{width: '110px'}}>Slug</span></th>
                                    ...
                                    data.data.map((elemt, i) => (
                                        <tr data-row="0" className="kt-datatable__row" style={{left: '0px'}} key={i}>
                                            ...
                                            <td data-field="ShipDate" className="kt-datatable__cell"><span
                                                style={{width: '110px'}}>{elemt.slug}</span></td>
                                            ...
                                            <td data-field="Actions" data-autohide-disabled="false"
                                                ...
                                                <a data-toggle="dropdown" className="btn btn-sm btn-clean btn-icon btn-icon-md">
                                                </a>
                                                    <div className="dropdown-menu dropdown-menu-right">
                                                        <a href="#" className="dropdown-item"><i className="la la-edit"></i> Edit Details</a>
                                                        <a href="#" className="dropdown-item"><i className="la la-leaf"></i> Update Status</a>
                                                        <a href="#" className="dropdown-item"><i className="la la-print"></i> Generate Report</a>
                                                    </div>
                                                </div>
                                                <Link to={`/settings/faq/category/${elemt.slug}`} title="Edit details" className="btn btn-sm btn-clean btn-icon btn-icon-md" >
                                                    <i className="la la-edit text-primary"></i>
                                                </Link>
                                                <a href="#" title="Delete" className="btn btn-sm btn-clean btn-icon btn-icon-md" onClick={(e)=>onDeleted(elemt.id)}>
...
export default FaqCategoryDataTable;
...
const SeverityLevel = (props) => {
    ...
    const filterShowListBySearchValue = (value) => {
        ...
        newSeverityLeveles = newSeverityLeveles.filter(el => (
            ...
            getLowerCaseString(el.color ? `${el.color} ${el.color === "#ffffff" ? t("Blanc") : ""}` : `-`).indexOf(value) >= 0 ||
            ...
            <tr key={index} role="row" className="odd">
                ...
                <td>
                    <div className="p-2 text-center" style={{backgroundColor: severityLevel.color, color: severityLevel.color === "#ffffff" ? "black" : "white"}}>
                        {severityLevel.color ? `${severityLevel.color} ${severityLevel.color === "#ffffff" ? t("Blanc") : ''}` : <strong style={{color: "black"}}>-</strong>}
                    </div>
                </td>
                                                    ...
                                                    <table
                                                        ...
                                                        <tr role="row">
                                                            <th className="sorting" tabIndex="0" aria-controls="kt_table_1" rowSpan="1"
                                                                ...
                                                                aria-label="Country: activate to sort column ascending">{t("Nom du niveau")}
                                                            </th>
                                                            <th className="sorting" tabIndex="0" aria-controls="kt_table_1" rowSpan="1"
                                                                colSpan="1" style={{ width: "70.25px" }}
                                                                aria-label="Country: activate to sort column ascending">{t("Couleur")}
                                                            </th>
                                                            <th className="sorting" tabIndex="0" aria-controls="kt_table_1" rowSpan="1"
                                                        ...
                                                        <tfoot>
                                                        <tr>
                                                            <th rowSpan="1" colSpan="1">{t("Nom du niveau")}</th>
                                                            <th rowSpan="1" colSpan="1">{t("Couleur")}</th>
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12 col-md-5">
                                                    <div className="dataTables_info" id="kt_table_1_info" role="status"
                                                         aria-live="polite">{t("Affichage de")} 1 {t("à")} {numberPerPage} {t("sur")} {severityLevels.length} {t("données")}
                                                    </div>
                                                </div>
                                                {
                                                    showList.length ? (

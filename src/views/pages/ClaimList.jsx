            ...
            verifyPermission(props.userPermissions, 'list-claim-awaiting-treatment') ? (
                <div className="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                    ...
                    <div className="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                        <InfirmationTable
                            information={t("Cette page vous présente la liste des réclamations transférées à votre unité et qui sont en attente d'affectation")}/>
                                                ...
                                                <div className="col-sm-12">
                                                    <table
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th rowSpan="1" colSpan="1">{props.plan === "PRO" ? t("Point de service visé") : t("Institution concernée")}</th>

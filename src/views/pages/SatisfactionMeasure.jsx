    ...
    const printBodyTable = (measure, index) => {
        return (
            <tr key={index} role="row" className="odd">
                ...
                <td>{`${measure.claimer && measure.claimer.lastname ? measure.claimer.lastname : ""} ${measure.claimer && measure.claimer.firstname ? measure.claimer.firstname : ""}  ${measure.account_targeted ? " / "+measure.account_targeted.number : (measure.account_number ? " / "+measure.account_number : "")}`}</td>
                <td>
                    {
                        (props.plan === 'PRO') ?
            ...
            <div className="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                ...
                <div className="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                    ...
                    <div className="kt-portlet">
                        ...
                        <HeaderTablePage
                            title={t("Mesure de Satisfaction")}
                        />
                        {
                            load ? (
                                <LoadingTable/>

...
const AddChatsForm = (props) => {
  ...
  const onSubmit = (e) => {
    ...
    if (verifyTokenExpire()) {
      axios
        .post(appConfig.apiDomaine + `/discussions`, data)
        .then((response) => {
                              ...
                              <div className="kt-section__body">
                                ...
                                >
                                  <label
                                    ...
                                    htmlFor="name"
                                  >
                                    {t("Nom de Discussion")} <InputRequire />
                                  </label>
                                  <div className="col-lg-9 col-xl-6">
                                    <input
                                      id="name"
  ...
  return verifyPermission(props.userPermissions, "store-discussion")
    ? printJsx()
    : null;
};

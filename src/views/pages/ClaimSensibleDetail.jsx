...
const ClaimSensibleDetail = (props) => {
                              ...
                              <div className="kt-wizard-v2__review-content">
                                ...
                                >
                                  ...
                                  <Select
                                    ...
                                    options={unitsData}
                                    placeholder={t(
                                      "Veuillez sélectionner l'unité de traitement"
                                    )}
                                  />
                                  {error.unit_id.length
...
export default connect(mapStateToProps)(ClaimSensibleDetail);

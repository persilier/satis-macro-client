                                        ...
                                        <div className="kt-widget__body">
                                            <div className="kt-widget__content">
                                                ...
                                                <div className="kt-widget__info">
                                                    ...
                                                    <a href="#"
                                                       className="kt-widget__data">{data.telephone.join("/")}</a>
                                                </div>
                                                <div className="kt-widget__info">
                                            ...
                                            <div className="kt-widget__items">
                                                <NavLink to="/settings/account/personal-information"
                                                ...
                                                <span className="kt-widget__section">
                                                    <span className="kt-widget__icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><g
                                                            ...
                                                            d="M12 11a4 4 0 110-8 4 4 0 010 8z" fill="#000"
                                                            fillRule="nonzero" opacity=".3"/><path
                                                ...
                                                <NavLink to="/settings/account/change-password"
                                                         className="kt-widget__item "
                                                         activeClassName="kt-widget__item--active">
                                                <span className="kt-widget__section">
                                                    <span className="kt-widget__icon">
                                                ...
                                                <NavLink to="/settings/account/channel" className="kt-widget__item"
                                                         activeClassName="kt-widget__item--active">
                                                <span className="kt-widget__section">
                                                    <span className="kt-widget__icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px"
                                                             height="24px" viewBox="0 0 24 24" version="1.1"
                                                             className="kt-svg-icon"><g stroke="none" strokeWidth="1"
                                                                                        fill="none" fillRule="evenodd"><rect
                                                            x="0" y="0" width="24" height="24"/><rect fill="#000000"
                                                                                                      x="4" y="5"
                                                                                                      width="16"
                                                                                                      height="3"
                                                                                                      rx="1.5"></rect><path

...
const RevivalMonitoringPilote = (props) => {
  ...
  if (
    !(
      verifyPermission(props.userPermissions, "show-my-pilot-monitoring") ||
      verifyPermission(props.userPermissions, "show-my-pilotUnit-monitoring") ||
      verifyPermission(props.userPermissions, "show-my-collector-monitoring") ||
      verifyPermission(props.userPermissions, "show-any-pilot-monitoring") ||
      verifyPermission(
        props.userPermissions,
        "show-any-pilotUnit-monitoring"
      ) ||
      verifyPermission(props.userPermissions, "show-any-collector-monitoring")
    )
  )
  ...
  const [claimCatsLeadPilot, setClaimsCatLeadPilot] = useState([
    { value: "assigned", label: "réclamations affectées" },
    { value: "validated", label: "réclamations validées" },
    { value: "surveyed", label: "réclamations enquêtées" },
  ]);
  const [claimCatsPilot, setClaimsCatPilot] = useState([
    { value: "assigned", label: "réclamations reçues" },
    { value: "treated", label: "réclamations traitées" },
    { value: "not_treated", label: "réclamations non traitées" },
  ]);
  const [typeSuivi, setTypeSuivi] = useState(
    isLeadPilot ? "suivi_pilot" : "suivi_unite"
  );
  ...
  useEffect(() => {
    const fetchInstitution = async () => {
      await axios
        .get(`${appConfig.apiDomaine}/my/institutions-whithout-holding`)
        .then(async (response) =>
          setInstitutions(
  ...
  const fetchData = useCallback(
    async (
      ...
      if (verifyPermission(props.userPermissions, "show-my-pilot-monitoring")) {
        endpoint = `${
          appConfig.apiDomaine
        }/my/monitoring-pilote?size=${numberPerPage}&page=${activeNumberPage}${
      ...
      if (
        ...
        endpoint = `${
          appConfig.apiDomaine
        }/any/monitoring-pilote?size=${numberPerPage}&page=${activeNumberPage}${
          type.status === true ? `&type=${type.value}` : ""
        }${search.status === true ? `&key=${search.value}` : ""}`;
      }
      ...
      await axios
        ...
        .then((response) => {
          ...
          newRevivals.allClaimAssignedTo = response.data.allClaimAssignedTo.data
            ? response.data.allClaimAssignedTo.data
            : [];
          ...
          newRevivals.getAverageTimeOfAssignation =
            response.data.getAverageTimeOfAssignation;
          newRevivals.getAverageTimeOfSatisfaction =
            response.data.getAverageTimeOfSatisfaction;
          newRevivals.getAverageTimeOfValidation =
            response.data.getAverageTimeOfValidation;
          console.log("newRevivals ", newRevivals.allClaimAssignedTo);
          setNumberPage(
            forceRound(response.data.allClaimAssignedTo.total / numberPerPage)
          );
          setShowList(
            response.data.allClaimAssignedTo.data.slice(0, numberPerPage)
          );
  ...
  const fetchDataSuiviCollector = useCallback(
    async (
      ...
      if (
        ...
        endpoint = `${
          appConfig.apiDomaine
        }/my/collector-pilot?size=${numberPerPage}&page=${activeNumberPage}${
          type.status === true ? `&type=${type.value}` : ""
        }${search.status === true ? `&key=${search.value}` : ""}`;
      }
      ...
      if (
        ...
        endpoint = `${
          appConfig.apiDomaine
        }/any/collector-pilot?size=${numberPerPage}&page=${activeNumberPage}${
          type.status === true ? `&type=${type.value}` : ""
        }${search.status === true ? `&key=${search.value}` : ""}`;
      }
      ...
      await axios
        ...
        .then((response) => {
          ...
          newRevivals.allClaimAssignedTo = response.data.claimSaved.data
            ? response.data.claimSaved.data
            : [];
          newRevivals.claimSatisfied = response.data.claimSatisfied;
          newRevivals.claimUnSatisfied = response.data.claimUnSatisfied;
          newRevivals.claimWithMeasureOfSAtisfaction =
            response.data.claimWithMeasureOfSAtisfaction;
          newRevivals.totalClaimSaved = response.data.totalClaimSaved;
          newRevivals.claimReceivedForMeasure =
            response.data.claimReceivedForMeasure;
          newRevivals.getAverageTimeOfSatisfaction =
            response.data.getAverageTimeOfSatisfaction;
          console.log("newRevivals ", newRevivals.claimSaved);
          setNumberPage(
            forceRound(response.data.claimSaved.total / numberPerPage)
          );
  ...
  const fetchDataSuiviUnit = useCallback(
    async (
      ...
      if (
        ...
        endpoint = `${
          appConfig.apiDomaine
        }/my/pilot-unit?size=${numberPerPage}&page=${activeNumberPage}${
          type.status === true ? `&type=${type.value}` : ""
        }${search.status === true ? `&key=${search.value}` : ""}`;
      }
      if (
        verifyPermission(props.userPermissions, "show-any-pilotUnit-monitoring")
      ) {
        endpoint = `${
          appConfig.apiDomaine
        }/any/pilot-unit?size=${numberPerPage}&page=${activeNumberPage}${
          type.status === true ? `&type=${type.value}` : ""
        }${search.status === true ? `&key=${search.value}` : ""}`;
      }
      sendData = {
  ...
  useEffect(() => {
    ...
    if (verifyPermission(props.userPermissions, "show-any-pilot-monitoring")) {
      urlPilote = `${appConfig.apiDomaine}/any/monitoring-pilote?institution_id=${institParam}`;
    }

    isLeadPilot &&
      typeSuivi == "suivi_pilot" &&
      axios
        .get(urlPilote)
        .then((response) => {
          ...
          for (let i = 0; i < response.data.pilote.length; i++) {
            response.data.pilote[i].label =
              response.data.pilote[i].identite.firstname +
              " " +
              response.data.pilote[i].identite.lastname;
            response.data.pilote[i].value =
              response.data.pilote[i].identite.staff.id;
          }
      ...
      axios
        ...
        .then((response) => {
          ...
          for (let i = 0; i < response.data.unit.length; i++) {
            response.data.unit[i].label =
              response.data.unit[i].name["fr"] + " ";
        ...
        .then((response) => {
          ...
          for (let i = 0; i < response.data.length; i++) {
            response.data[i].label =
              response.data[i].identite.firstname +
              " " +
              response.data[i].identite.lastname;
  ...
  const searchElement = async (e) => {
    ...
    if (e.target.value) {
      if (verifyTokenExpire()) {
        ...
        typeSuivi == "suivi_unite" &&
          fetchDataSuiviUnit(false, {
            status: true,
            value: getLowerCaseString(e.target.value),
          });
        typeSuivi == "suivi_collector" &&
          fetchDataSuiviCollector(false, {
            status: true,
            value: getLowerCaseString(e.target.value),
          });
      }
      ...
      <tr key={index} role="row" className="odd">
        ...
        <td>
          ...
          >
            ...
            <p>
              <strong>Mesure de satisfaction</strong>
            </p>
            <div className="row mb-3">
              <div className="col-3">
                <span>{t("Quota : ")}</span>
                <strong className="ml-2">
                  {revival?.timeLimitMeasureSatisfaction
                    ?.Quota_delay_assigned || "-"}
                </strong>
              </div>
              <div className="col-6">
                <span>{t("Durée effectuée : ")}</span>
              ...
              <div className="col-3">
                ...
                <strong className="ml-2">
                  {showValue(
                    revival?.timeLimitMeasureSatisfaction?.ecart_days_hours
                  )}
        ...
        <td>
          {revival.claimer?.raison_sociale
            ? revival.claimer?.raison_sociale
            : (revival.claimer?.lastname ? revival.claimer.lastname : "") +
              " " +
              (revival.claimer?.firstname ? revival.claimer.firstname : "")}
        </td>
        <td>{`${
        ...
        <td>
          {formatDateToTime(revival.active_treatment.transferred_to_unit_at)}
        </td>
        <td>
        ...
        <td className={"text-center"}>
          <a
            href={`/monitoring/perf/claims/${revival?.claim_id}/detail`}
    ...
    >
      ...
      <div className="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div className="kt-portlet">
          <HeaderTablePage title={t("Suivi des performances")} />
          ...
          <div className="kt-portlet__body">
            ...
            >
                      ...
                      <div className="kt-widget6__body">
                          ...
                          <div
                            className={
                              error.institution_targeted_id.length
                                ? "form-group validated kt-widget6__item row"
                                : "form-group kt-widget6__item row"
                            }
                        ...
                        {true ? (
                          <div className="form-group row">
                            {isLeadPilot && (
                              <div
                                className={"col d-flex align-items-center mt-4"}
                              >
                                <label className="kt-checkbox">
                                  <input
                                    ...
                                    onChange={() =>
                                      handleChangeTypeSuivi("suivi_pilot")
                                    }
                                  />
                              ...
                              >
                                <label className="kt-checkbox">
                                  <input
                                    ...
                                    onChange={() =>
                                      handleChangeTypeSuivi("suivi_unite")
                                    }
                                  />
                              ...
                              >
                                <label className="kt-checkbox">
                                  <input
                                    ...
                                    onChange={() =>
                                      handleChangeTypeSuivi("suivi_collector")
                                    }
                                  />
              ...
              <div className="text-center m-auto col-xl-10 col-lg-10 order-lg-3 order-xl-1">
                <div
                          ...
                          <>
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Nombre de réclamations reçues à ce jour
                              </span>
                              <span
                              ...
                              >
                                {revivals.totalClaimAssigned !== undefined &&
                                revivals.totalClaimAssigned !== null
                                  ? revivals.totalClaimAssigned
                                  : "-"}
                              </span>
                            </div>
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Nombre de réclamations déjà traitées à ce jour
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                                style={{
                              ...
                              >
                                {revivals.totalClaimTreated !== undefined &&
                                revivals.totalClaimTreated !== null
                                  ? revivals.totalClaimTreated
                                  : "-"}
                              </span>
                            </div>
                            <div
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Nombre de réclamations restant à traiter à ce
                                jour
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                              ...
                              >
                                {revivals.totalClaimNotTreated !== undefined &&
                                revivals.totalClaimNotTreated !== null
                                  ? revivals.totalClaimNotTreated
                                  : "-"}
                              </span>
                            </div>
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Nbre de réclamations qui ont eu de retour
                                satisfaisant
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                              ...
                              >
                                {revivals.totalClaimSatisfied !== undefined &&
                                revivals.totalClaimSatisfied !== null
                                  ? revivals.totalClaimSatisfied
                                  : "-"}
                              </span>
                            </div>
                            ...
                            >
                              ...
                              >
                                {revivals.getAverageTimeOfAssignation !==
                                  undefined &&
                                revivals.getAverageTimeOfAssignation !== null
                                  ? revivals.getAverageTimeOfAssignation
                                  : "-"}
                              </span>
                            </div>
                          ...
                          <>
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Nombre de Réclamations Affectées à ce jour
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                                style={{
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Nombre de Réclamations déjà Validées à ce jour:
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                                style={{
                              ...
                              >
                                {revivals.totalClaimValidated !== undefined &&
                                revivals.totalClaimValidated !== null
                                  ? revivals.totalClaimValidated
                                  : "-"}
                              </span>
                            </div>
                            <div
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Nombre de Réclamations rejetées à la validation
                                à ce jour
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                              ...
                              >
                                {revivals.totalClaimRejected !== undefined &&
                                revivals.totalClaimRejected !== null
                                  ? revivals.totalClaimRejected
                                  : "-"}
                              </span>
                            </div>
                            {/* Start Performances */}
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Nombre de Réclamants dont la mesure de
                                satisfaction est fait à ce jour
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                                style={{
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Temps moyen de transfert d'une réclamation
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                                style={{
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Temps moyen de validation d'une réclamation
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                                style={{
                              ...
                              >
                                {revivals.getAverageTimeOfValidation !==
                                  undefined &&
                                revivals.getAverageTimeOfValidation !== null
                                  ? revivals.getAverageTimeOfValidation
                                  : "-"}
                              </span>
                            </div>
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Temps moyen de mesure de satisfaction d'un
                                réclamant
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                              ...
                              >
                                {revivals.getAverageTimeOfSatisfaction !==
                                  undefined &&
                                revivals.getAverageTimeOfSatisfaction !== null
                                  ? revivals.getAverageTimeOfSatisfaction
                                  : "-"}
                              </span>
                            </div>
                        ...
                        {typeSuivi == "suivi_collector" && (
                          <>
                            ...
                            >
                              ...
                              >
                                {revivals.totalClaimSaved !== undefined &&
                                revivals.totalClaimSaved !== null
                                  ? revivals.totalClaimSaved
                                  : "-"}
                              </span>
                            </div>
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Nombre de réclamations reçues pour mesure de
                                satisfaction :
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                              ...
                              >
                                {revivals.claimReceivedForMeasure !==
                                  undefined &&
                                revivals.claimReceivedForMeasure !== null
                                  ? revivals.claimReceivedForMeasure
                                  : "-"}
                              </span>
                            </div>
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Nombre de réclamations dont la mesure de
                                satisfaction a été effectuée :
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                                style={{
                              ...
                              >
                                {revivals.claimWithMeasureOfSAtisfaction !==
                                  undefined &&
                                revivals.claimWithMeasureOfSAtisfaction !== null
                                  ? revivals.claimWithMeasureOfSAtisfaction
                                  : "-"}
                              </span>
                            </div>
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Temps moyen pour la mesure de satisfaction d'une
                                réclamation :
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                            ...
                            >
                              ...
                              >
                                {revivals.claimSatisfied !== undefined &&
                                revivals.claimSatisfied !== null
                                  ? revivals.claimSatisfied
                                  : "-"}
                              </span>
                            </div>
                            ...
                            >
                              <span
                                ...
                                style={{ fontWeight: "500" }}
                              >
                                Nbre de réclamations qui ont eu de retour non
                                satisfaisant :
                              </span>
                              <span
                                className="col-lg-2 kt-font-brand kt-font-bold"
                              ...
                              >
                                {revivals.claimUnSatisfied !== undefined &&
                                revivals.claimUnSatisfied !== null
                                  ? revivals.claimUnSatisfied
                                  : "-"}
                              </span>
                            </div>
                          </>
              ...
              <div className="row">
                        ...
                        >
                          ...
                          <div className="d-flex justify-content-center mt-1 mb-1">
                            <button
                              ...
                              onClick={(e) =>
                                onClickTag("reference", t("Référence"), "dark")
                              }
                            >
                              {t("Référence")}
                            </button>
                ...
                {typeSuivi !== "suivi_collector" && (
                  <Select
                    placeholder={t(
                      "Veuillez sélectionner le type de réclamation"
                    )}
                    className="col-sm-6"
                    size="extra-small"
                    value={claimCat}

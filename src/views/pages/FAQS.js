...
const FAQS = () =>{
    ...
    const onDeleted=(elemt)=>{
        axios.delete(`http://127.0.0.1:8000/faqs/${elemt}`
        )
                            ...
                            <div className="kt-portlet__head-wrapper">
                                ...
                                <div className="dropdown dropdown-inline">
                                    <button type="button" className="btn btn-bold btn-label-brand btn-sm" data-toggle="modal"
                                        ...
                                        <i className="flaticon2-plus"></i> Add FAQ
                                    </button>
                                    ...
                                    data.data.map((elemt, i) => (
                                        <tr data-row="0" className="kt-datatable__row" style={{left: '0px'}} key={i}>
                                            ...
                                            <td data-field="Actions" data-autohide-disabled="false"
                                                ...
                                                className="dropdown">
                                                <a data-toggle="dropdown" className="btn btn-sm btn-clean btn-icon btn-icon-md">                                <i
                                                ...
                                                <Link to={`/settings/faq/${elemt.slug}`} title="Edit details" className="btn btn-sm btn-clean btn-icon btn-icon-md">
                                                <i className="la la-edit text-primary"></i>
                                                </Link>
                                                <a title="Delete" className="btn btn-sm btn-clean btn-icon btn-icon-md " onClick={()=>onDeleted(elemt.id)}>

...
const TypeCompte = (props) => {
    ...
    useEffect(() => {
        if (verifyTokenExpire()) {
            axios.get(appConfig.apiDomaine + "/account-types")
                .then(response => {
                    setLoad(false);
    ...
    const onClickPage = (e, page) => {
        ...
        setShowList(typeCompte.slice(getEndByPosition(page) - numberPerPage, getEndByPosition(page)));
    };
                ...
                <td style={{textAlign:"center"}}>
                    {
                        verifyPermission(props.userPermissions, 'show-account-type')?
                            <Link to={`/settings/accounts/type/edit/${type.id}`}
            ...
            verifyPermission(props.userPermissions, "list-account-type") ? (
                <div className="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                    ...
                    <div className="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                        <InfirmationTable
                            information={t("Liste des types de compte")}/>
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12 col-md-5">
                                                    <div className="dataTables_info" id="kt_table_1_info" role="status"
                                                         aria-live="polite">
                                                        {typeCompte.length ?
                                                            `${t("Affichage de")} 1 ${t("à")} ${numberPerPage} ${t("sur")} ${typeCompte.length} ${t("données")}`
                                                            :

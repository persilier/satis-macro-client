...
const ConfigConnexion = (props) => {
  ...
  if (
    !(
      verifyPermission(props.userPermissions, "list-auth-config") ||
      verifyPermission(props.userPermissions, "update-auth-config")
    )
  )
      ...
      await axios
        ...
        .then(({ data }) => {
          setData({
            ...
            password_expiration_msg: JSON.parse(data.data.fr)
              .password_expiration_msg,
            block_attempt_control: JSON.parse(data.data.fr)
              .block_attempt_control,
  ...
  const onSubmit = async (e) => {
    ...
    if (verifyTokenExpire()) {
      await axios
        .put(`${appConfig.apiDomaine}/auth-config`, sendData)
        .then((response) => {
                ...
                <div className="kt-form">
                  <div className="kt-portlet__body">
                      ...
                      <div className="kt-section__body">
                        ...
                        <div className="form-group row">
                          <label className="col-4 col-form-label">
                            {t("Contrôle du temps d'inactivité")}{" "}
                            <InputRequire />
                          </label>
                          <div className="col-3">
                        ...
                        >
                          <label
                            ...
                            htmlFor="inactivity_time_limit"
                          >
                            {t("Durée d'inactivité maximale tolérée en jours")}{" "}
                            <InputRequire />
                          </label>
                          <div className="col-lg-8 col-xl-6">
                            ...
                            />
                            {error.inactivity_time_limit.length
                              ? error.inactivity_time_limit.map(
                                  (error, index) => (
                                    <div
                                      key={index}
                        ...
                        >
                          <label
                            className="col-xl-3 col-lg-4 col-form-label"
                            htmlFor="inactive_account_msg"
                          >
                            {t(
                              "Message à envoyer à l'utilisateur à la désactivation de son compte"
                            )}{" "}
                            <InputRequire />
                          </label>
                          <div className="col-lg-8 col-xl-6">
                            ...
                            />
                            {error.inactive_account_msg.length
                              ? error.inactive_account_msg.map(
                                  (error, index) => (
                                    <div
                                      key={index}
                                      className="invalid-feedback"
                    ...
                    <div className="kt-section">
                      <div className="kt-section__body">
                        <h3 className="kt-section__title kt-section__title-lg">
                          {t("Expiration du mot de passe")}
                        </h3>

                        <div className="form-group row">
                          <label className="col-4 col-form-label">
                            {t("Expiration du mot de passe")} <InputRequire />
                          </label>
                          <div className="col-3">
                            <span className="kt-switch">
                              <label>
                                <input
                                  ...
                                  onChange={(e) =>
                                    onChangePasswordExpirationControl(e)
                                  }
                                />
                                <span />
                              </label>
                        ...
                        >
                          ...
                          <div className="col-lg-8 col-xl-6">
                            <input
                              ...
                              onChange={(e) =>
                                onChangePasswordExpirationTime(e)
                              }
                            />
                            {error.password_lifetime.length
                        ...
                        >
                          <label
                            className="col-xl-3 col-lg-4 col-form-label"
                            htmlFor="max_password_histories"
                          >
                            {t(
                              "Nombre maximal de mot de passe dans l'historique des mot de passe"
                            )}{" "}
                            <InputRequire />
                          </label>
                          <div className="col-lg-8 col-xl-6">
                            ...
                            />
                            {error.max_password_histories.length
                              ? error.max_password_histories.map(
                                  (error, index) => (
                                    <div
                                      key={index}
                                      className="invalid-feedback"
                        ...
                        >
                          ...
                          <div className="col-lg-8 col-xl-6">
                            ...
                            />
                            {error.password_notif_delay.length
                              ? error.password_notif_delay.map(
                                  (error, index) => (
                                    <div
                                      key={index}
                                      className="invalid-feedback"
                        ...
                        >
                          <label
                            className="col-xl-3 col-lg-4 col-form-label"
                            htmlFor="imminent_password_expiration"
                          >
                            {t(
                              "Message à envoyer à l'utilisateur pour le notifier que l'expiration de son mot de passe est imminent"
                            )}{" "}
                            <InputRequire />
                          </label>
                          <div className="col-lg-8 col-xl-6">
                            <textarea
                              ...
                              onChange={(e) =>
                                onChangeMessageImminentPasswordExpiration(e)
                              }
                            />
                            {error.password_notif_msg.length
                        ...
                        >
                          <label
                            className="col-xl-3 col-lg-4 col-form-label"
                            htmlFor="for_password_expiration"
                          >
                            {t(
                              "Message à envoyer à l'utilisateur le jour de l'expiration de son mot de passe"
                            )}{" "}
                            <InputRequire />
                          </label>
                          <div className="col-lg-8 col-xl-6">
                            <textarea
                              ...
                              onChange={(e) =>
                                onChangeMessageForPasswordExpiration(e)
                              }
                            />
                            {error.password_expiration_msg.length
                              ? error.password_expiration_msg.map(
                                  (error, index) => (
                                    <div
                                      key={index}
                                      className="invalid-feedback"
                    ...
                    <div className="kt-section">
                      <div className="kt-section__body">
                        <h3 className="kt-section__title kt-section__title-lg">
                          {t("Tentatives de connexion")}
                        </h3>

                        <div className="form-group row">
                          <label className="col-4 col-form-label">
                            {t("Tentatives de connexion manquées")}{" "}
                            <InputRequire />
                          </label>
                          <div className="col-3">
                            <span className="kt-switch">
                        ...
                        >
                          ...
                          >
                            {t(
                              "Nombre maximal de tentatives manquées tolérable"
                            )}{" "}
                            <InputRequire />
                          </label>
                          <div className="col-lg-8 col-xl-6">
                        ...
                        >
                          ...
                          <div className="col-lg-8 col-xl-6">
                            <input
                              ...
                              onChange={(e) =>
                                onChangeMaxTimeBetweenAttempts(e)
                              }
                            />
                            {error.attempt_delay.length
                        ...
                        >
                          ...
                          <div className="col-lg-8 col-xl-6">
                            <input
                              ...
                              onChange={(e) =>
                                onChangeWaitingTimeAfterMaxAttempts(e)
                              }
                            />
                            {error.attempt_waiting_time.length
                              ? error.attempt_waiting_time.map(
                                  (error, index) => (
                                    <div
                                      key={index}
                                      className="invalid-feedback"

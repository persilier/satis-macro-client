...
const ClaimReassignDetailPending = (props) => {
  ...
  useEffect(() => {
    async function fetchData() {
      await axios
        .get(
          `${appConfig.apiDomaine}/claim-reassignment/${id}/edit/?type=unsatisfied`
        )
        .then((response) => {
  ...
  const assignClaim = () => {
    ...
    if (verifyTokenExpire()) {
      axios
        .put(
          `${appConfig.apiDomaine}/claim-reassignment/${id}/?type=unsatisfied`,

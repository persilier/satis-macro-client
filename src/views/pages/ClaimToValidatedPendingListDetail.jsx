...
const ClaimToValidatedPendingListDetail = (props) => {
                                      ...
                                      <>
                                        <div className="kt-wizard-v2__review-item">
                                          ...
                                          <div className="kt-wizard-v2__review-content">
                                            ...
                                            :
                                            <span className="mx-2">
                                              {claim.active_treatment.comments
                                                ? claim.active_treatment
                                                    .comments
                                                : "-"}
                                            </span>
                                      ...
                                      <>
                                        ...
                                        <div className="kt-widget__action">
                                          <button
                                            ...
                                            className="btn btn-label-danger btn-sm btn-upper"
                                            onClick={() =>
                                              showReasonInput("validateReject")
                                            }
                                          >
                                            {t("Rejeter")}
                                          </button>
...
export default connect(mapStateToProps)(ClaimToValidatedPendingListDetail);

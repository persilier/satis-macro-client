...
const ClaimReportingUemoaHeight = (props) => {
      ...
      <tr>
        {index === 0 ? (
          <td style={{ fontWeight: "bold" }} rowSpan={tableSize}>
            {t("Objets de plaintes les plus récurrents")}{" "}
          </td>
        ) : null}
        <td style={{ textAlign: "center", fontWeight: "bold" }}>
          {item.rank ?? "-"}{" "}
  ...
  const parseSpecificReportTable = (
    object,
    typeStatistic,
    unitId,
    type = "total"
    ...
    for (var i = 0; i < unit.length; i++) {
      ...
      for (var j = 0; j < object.RecurringClaimsByClaimObject.length; j++) {
        if (unit[i].label === object.RecurringClaimsByClaimObject[j].unit.fr) {
          ...
          for (
            var k = 0;
            k < object.RecurringClaimsByClaimObject[j].allClaimObject.length;
            k++
          ) {
            if (
              object.RecurringClaimsByClaimObject[j].allClaimObject[k].rank ===
              rank
            ) {
              checkUnit = 1;
              resultRank.push(
                object.RecurringClaimsByClaimObject[j].allClaimObject[k]
                  .ClaimsObject.fr
              );
            }
          }
                    ...
                    <div className="col">
                      ...
                      >
                        ...
                        {unit.length > 3 ? (
                          ...
                          >
                            Vous avez atteint le nombre maximal d'agences à
                            sélectionner
                          </p>
                        ) : null}
                    ...
                    <div className="mb-5 row">
                      ...
                      >
                        {typeRapport === "GLOBAL" ? (
                          ...
                          >
                            <h6 style={{ textAlign: "center" }}>
                              {statistics.title ? `Rapport consolidé` : ""}{" "}
                        ...
                        {typeRapport === "SPECIFIC" ? (
                          ...
                          >
                            <h6 style={{ textAlign: "center" }}>
                              Rapport spécifique par institution du{" "}
                              {moment(dateStart).format("DD/MM/YYYY") +
                                " À " +
                                moment(dateEnd).format("DD/MM/YYYY")}{" "}
                            </h6>
                            <p style={{ textAlign: "center" }}>
                              {statistics.description
                                ? `Rapport spécifique par institution`
                                : ""}
                            </p>
                          </div>
                        ) : null}
                        ...
                        {typeRapport === "GLOBAL" ? (
                          <div className={"GLOBAL"}>
                              ...
                              >
                                ...
                                <tbody>
                                  <tr>
                                    <td style={{ fontWeight: "bold" }}>
                                      {t(
                                        "Taux de résolution rapide des plaintes"
                                      )}{" "}
                                    </td>
                                    <td
                                      style={{
                                    ...
                                    >
                                      {statistics.RateOfClaimsTreatedInTime
                                        ?.taux !== undefined &&
                                      statistics.RateOfClaimsTreatedInTime
                                        ?.taux !== null
                                        ? statistics.RateOfClaimsTreatedInTime
                                  ...
                                  <tr>
                                    <td style={{ fontWeight: "bold" }}>
                                      {t("Taux de satisfaction des plaignants")}{" "}
                                    </td>
                                    <td
                                      style={{
                                        textAlign: "center",
                                    ...
                                    >
                                      {statistics.RateOfClaimsSatisfaction
                                        ?.taux !== undefined &&
                                      statistics.RateOfClaimsSatisfaction
                                        ?.taux !== null
                                        ? statistics.RateOfClaimsSatisfaction
                                  ...
                                  <tr>
                                    <td style={{ fontWeight: "bold" }}>
                                      {t(
                                        "Taux de résolution rapide des plaintes très graves"
                                      )}{" "}
                                    </td>
                                    <td
                                      style={{
                                    ...
                                    >
                                      {statistics
                                        .RateOfHighlyClaimsTreatedInTime
                                        ?.taux !== undefined &&
                                      statistics.RateOfHighlyClaimsTreatedInTime
                                        ?.taux !== null
                                        ? statistics
                                            .RateOfHighlyClaimsTreatedInTime
                                            .taux + "%"
                              ...
                              >
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    >
                                      {statistics.TotalClaimsReceived !==
                                        undefined &&
                                      statistics.TotalClaimsReceived !== null
                                        ? statistics.TotalClaimsReceived
                                        : "-"}{" "}
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    >
                                      {statistics.TotalClaimsResolved !==
                                        undefined &&
                                      statistics.TotalClaimsResolved !== null
                                        ? statistics.TotalClaimsResolved
                                        : "-"}{" "}
                                    </td>
                                  </tr>
                                  <tr>
                                    <td
                                      ...
                                      colSpan={2}
                                    >
                                      {t("Nombre de plaintes non traitées")}{" "}
                                    </td>
                                    <td
                                      style={{
                                        textAlign: "center",
                                    ...
                                    >
                                      {statistics.TotalClaimsUnresolved !==
                                        undefined &&
                                      statistics.TotalClaimsUnresolved !== null
                                        ? statistics.TotalClaimsUnresolved
                                        : "-"}{" "}
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    >
                                      {t(
                                        "Nombre de plaintes traitées dans les délais"
                                      )}{" "}
                                    </td>
                                    <td
                                      style={{
                                    ...
                                    >
                                      {statistics.TotalClaimResolvedOnTime
                                        ?.taux !== undefined &&
                                      statistics.TotalClaimResolvedOnTime
                                        ?.taux !== null
                                        ? statistics.TotalClaimResolvedOnTime
                                  ...
                                  <tr>
                                    ...
                                    >
                                      {t(
                                        "Nombre de plaintes traitées en retard"
                                      )}{" "}
                                    </td>
                                    <td
                                      style={{
                                    ...
                                    >
                                      {statistics.TotalClaimResolvedLate !==
                                        undefined &&
                                      statistics.TotalClaimResolvedLate !== null
                                        ? statistics.TotalClaimResolvedLate
                                        : "-"}{" "}
                                    </td>
                                  </tr>
                            ...
                            <div>
                              <h4>
                                3.{" "}
                                {t("Plaintes reçues par catégorie de plainte")}{" "}
                              </h4>
                              ...
                              >
                                ...
                                <tbody>
                                  {statistics.ClaimsReceivedByClaimCategory
                                    ?.length ? (
                                    statistics.ClaimsReceivedByClaimCategory
                                      ?.length ? (
                                      statistics.ClaimsReceivedByClaimCategory.map(
                                        (item, index) =>
                            ...
                            <div>
                              <h4>
                                4. {t("Plaintes reçues par objet de plainte")}{" "}
                              </h4>
                              ...
                              >
                                ...
                                <tbody>
                                  {statistics.ClaimsReceivedByClaimObject
                                    ?.length ? (
                                    statistics.ClaimsReceivedByClaimObject
                                      ?.length ? (
                                      statistics.ClaimsReceivedByClaimObject.map(
                                        (item, index) =>
                            ...
                            <div>
                              <h4>
                                5. {t("Plaintes reçues par sexe de clients")}{" "}
                              </h4>
                              ...
                              >
                                ...
                                <tbody>
                                  {statistics.ClaimsReceivedByClientGender
                                    ?.length ? (
                                    statistics.ClaimsReceivedByClientGender
                                      ?.length ? (
                                      statistics.ClaimsReceivedByClientGender.map(
                                        (item, index) =>
                              ...
                              >
                                ...
                                <tbody>
                                  <tr>
                                    <td style={{ fontWeight: "bold" }}>
                                      {t(
                                        "Nombre de clients contacté après traitement"
                                      )}{" "}
                                    </td>
                                    <td
                                      style={{
                                    ...
                                    >
                                      {statistics.ClientContactedAfterTreatment !==
                                        undefined &&
                                      statistics.ClientContactedAfterTreatment !==
                                        null
                                        ? statistics.ClientContactedAfterTreatment
                                  ...
                                  <tr>
                                    <td style={{ fontWeight: "bold" }}>
                                      {t("Nombre de clients satisfaits")}{" "}
                                    </td>
                                    <td
                                      style={{
                                        textAlign: "center",
                                    ...
                                    >
                                      {statistics.NumberOfClientSatisfied
                                        ?.total !== undefined &&
                                      statistics.NumberOfClientSatisfied
                                        ?.total !== null
                                        ? statistics.NumberOfClientSatisfied
                                    ...
                                    >
                                      {statistics.PercentageOfClientSatisfied
                                        ?.taux !== undefined &&
                                      statistics.PercentageOfClientSatisfied
                                        ?.taux !== null
                                        ? statistics.PercentageOfClientSatisfied
                                  ...
                                  <tr>
                                    <td style={{ fontWeight: "bold" }}>
                                      {t("Nombre de clients non-satisfaits")}
                                    </td>
                                    <td
                                      style={{
                                        textAlign: "center",
                                    ...
                                    >
                                      {statistics.NumberOfClientDissatisfied !==
                                        undefined &&
                                      statistics.NumberOfClientDissatisfied !==
                                        null
                                        ? statistics.NumberOfClientDissatisfied
                                    ...
                                    >
                                      {statistics.PercentageOfClientDissatisfied
                                        ?.taux !== undefined &&
                                      statistics.PercentageOfClientDissatisfied
                                        ?.taux !== null
                                        ? statistics
                                            .PercentageOfClientDissatisfied
                                            .taux + "%"
                                        : "-"}{" "}
                                    </td>
                                  </tr>
                                  ...
                                  <tr role="row">
                                    ...
                                    >
                                      ...
                                      >
                                        <h6>
                                          {t(
                                            "Raisons du retard dans le traitement des réclamations :"
                                          )}
                                        </h6>
                                      </label>
                                    </th>
                                    ...
                                    >
                                      ...
                                      >
                                        <h6>
                                          {t(
                                            "Commentaires / Synthèse générale :"
                                          )}
                                        </h6>
                                      </label>
                                    </th>
                              ...
                              >
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    >
                                      {t(
                                        "Nombre de clients notifiés après traitement"
                                      )}{" "}
                                    </td>
                                    {labelTable.length ? (
                                      unitFilters.map((item, index) => (
                                  ...
                                  <tr>
                                    ...
                                    >
                                      {t(
                                        "Objets de plaintes les plus récurrents"
                                      )}{" "}
                                    </td>
                                    <td style={{ fontWeight: "bold" }}>
                                      {t("1er")}{" "}
                    ...
                    <div className="alert alert-secondary mt-4" role="alert">
                      <div className="row ">
                        ...
                        <div className="col-md-6">
                          ...
                          >
                            <h6>{t("Commentaires / Synthèse générale :")}</h6>
                          </label>
                          <textarea
                            name=""
                            id=""
                            onChange={handleCommentTwo}
                            cols="20"
                            value={commentTwo}
                            rows="7"
                            style={{

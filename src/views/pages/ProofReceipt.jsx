...
const   ProofReceipt = (props) => {
    ...
    else if (verifyPermission(props.userPermissions, 'list-any-notification-proof'))
                                    ...
                                    <div id="kt_table_1_wrapper" className="dataTables_wrapper dt-bootstrap4">
                                        <div className="row">
                                            ...
                                            <div className="form-group text-right col-12">
                                                {startFilter ? (
                                                    <button
                                                        className="btn btn-brand kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light">Chargement...
                                                    </button>
                                                ) : (
                                                ...
                                                <table
                                                    ...
                                                    <tr role="row">
                                                        ...
                                                        <th className="sorting" tabIndex="0" aria-controls="kt_table_1" rowSpan="1"
                                                            ...
                                                            aria-label="Country: activate to sort column ascending">Destinataire
                                                        </th>
                                                        <th className="sorting" tabIndex="0" aria-controls="kt_table_1" rowSpan="1"
                                                            colSpan="1" style={{ width: "50px" }}
                                                            aria-label="Country: activate to sort column ascending">Canal
                                                        </th>
                                                        <th className="sorting" tabIndex="0" aria-controls="kt_table_1" rowSpan="1"
                                                            colSpan="1" style={{ width: "70.25px" }}
                                                            aria-label="Country: activate to sort column ascending">Contenu/message
                                                        </th>
                                                        <th className="sorting" tabIndex="0" aria-controls="kt_table_1" rowSpan="1"
                                                            colSpan="1" style={{ width: "70.25px" }}

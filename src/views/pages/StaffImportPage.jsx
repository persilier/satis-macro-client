...
const StaffImportPage = (props) => {
  ...
  document.title = ready
    ? t("Satis client - Importation objet de réclamation")
    : "";
  if (
    !(
      ...
      verifyPermission(props.userPermissions, "store-staff-from-maybe-no-unit")
    )
  )
  ...
  const formatFormData = (newData) => {
    ...
    for (const key in newData) {
      if (key === "file") formData.append("file", newData.file);
  ...
  const onSubmit = async (e) => {
    ...
    if (endpoint.length) {
      ...
      if (verifyTokenExpire()) {
        await axios
          .post(endpoint, formatFormData(data))
          .then((response) => {
                    ...
                    <div className="kt-portlet__body">
                      <div className="form-group validated row">
                        <label className="col-3 col-form-label">
                          {t("Stop identité existe")} <InputRequire />
                        </label>
                        <div className="col-9">
                          <div className="kt-radio-inline">
                            <label className="kt-radio">
                              <input
                                ...
                                checked={optionOne === data.stop_identite_exist}
                              />{" "}
                              {t("Oui")}
                              <span />
                            </label>
                            <label className="kt-radio">
                              <input
                                ...
                                value={optionTwo}
                                onChange={handleOptionOneChange}
                                checked={optionTwo === data.stop_identite_exist}
                              />{" "}
                              {t("Non")}
                              <span />
                            </label>
                          ...
                          <div className="kt-radio-inline">
                            <label className="kt-radio">
                              <input
                                ...
                                checked={optionThree === data.etat_update}
                              />{" "}
                              {t("Oui")}
                              <span />
                            </label>
                            <label className="kt-radio">
                              <input
                                ...
                                value={optionFour}
                                onChange={handleOptionTwoChange}
                                checked={optionFour === data.etat_update}
                              />{" "}
                              {t("Non")}
                              <span />
                            </label>

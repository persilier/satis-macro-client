...
const ConfigTitreRapportEdit = (props) => {
  ...
  useEffect(() => {
    if (name) {
      if (verifyTokenExpire()) {
        axios
          .get(appConfig.apiDomaine + `/reporting-metadata/${name}`)
          .then((response) => {
            const newTitle = {
  ...
  const onSubmit = (e) => {
    ...
    if (verifyTokenExpire()) {
      if (name) {
        axios
          .put(appConfig.apiDomaine + `/reporting-metadata`, data)
          .then((response) => {
                ...
                <div className="kt-portlet__head">
                  <div className="kt-portlet__head-label">
                    <h3 className="kt-portlet__head-title">
                      {name
                        ? "Modification des Titres de Rapport"
                        : " Ajout des Titres de Rapport"}
                    </h3>
                  </div>
                </div>

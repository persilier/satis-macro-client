   ...
   /* const [data, setData] = useState(defaultData);*/
    ...
    useEffect(() => {
        if (verifyTokenExpire()) {
            axios.get(appConfig.apiDomaine + `/reporting-metadata/${id}`)
                .then(response => {
    ...
    const saveData = (e) => {
        ...
        executeSave(`${appConfig.apiDomaine}/reporting-metadata/${id}`, dataToSend);
    };
                                ...
                                <div className="kt-portlet__head">
                                    <div className="kt-portlet__head-label">
                                        <h3 className="kt-portlet__head-title">
                                            Modification Configuration Titre Rapport
                                        </h3>
                                    </div>
                                </div>
...
*/}
                                        ...
                                        <div className="kt-portlet__foot">
                                            <div className="kt-form__actions text-right">
                                                ...
                                                {
                                                    !startRequest ? (
                                                        <Link to="/settings/config-rapport"

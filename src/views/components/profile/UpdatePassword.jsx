                            ...
                            <div className="kt-section__body">
                                <div className="row">
                                    ...
                                    <div className="col-lg-9 col-xl-6">
                                        <h3 className="kt-section__title kt-section__title-sm">{t("Changer ou récupérer votre mot de passe")}:</h3>
                                    </div>
                                </div>

                                <div className={error.current_password.length ? "form-group row validated" : "form-group row"}>
                                    <label className="col-xl-3 col-lg-3 col-form-label">{t("Ancien")}</label>
                                    <div className="col-lg-9 col-xl-6">
                                ...
                                <div className={error.new_password.length ? "form-group row validated" : "form-group row"}>
                                    <label className="col-xl-3 col-lg-3 col-form-label">{t("Nouveau")}</label>
                                    <div className="col-lg-9 col-xl-6">
                                ...
                                <div className={error.new_password_confirmation.length ? "form-group row validated" : "form-group row"}>
                                    <label className="col-xl-3 col-lg-3 col-form-label">{t("Confirmation")}</label>
                                    <div className="col-lg-9 col-xl-6">

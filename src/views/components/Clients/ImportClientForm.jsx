...
const ImportClientForm = (props) => {
  ...
  document.title = ready
    ? t("Satis client - Importation de fichier excel")
    : null;
  ...
  const onSubmit = (e) => {
    ...
    if (verifyTokenExpire()) {
      axios
        .post(endPoint.store, formatFormData(data))
        .then((response) => {
          ...
          if (response.status === 201) {
            ToastBottomEnd.fire(
              toastSuccessMessageWithParameterConfig(
                t("Veuillez patienter le processus d'importation est en cours")
              )
            );
          }
        ...
        .catch(({ response }) => {
          ...
          if (response.data.error) {
            setErrorFile(response.data.error);
              ...
              <div className="kt-portlet">
                ...
                <form method="POST" className="kt-form">
                  <div className="kt-portlet__body">
                    ...
                    >
                      <label className="col-xl-3 col-lg-3 col-form-label">
                        {t("Est ce une mise a jour?")} <InputRequire />
                      </label>
                      <div className="kt-radio-inline col-lg-9 col-xl-6">
                        <label className="kt-radio kt-radio--bold kt-radio--success">
                          <input
                    ...
                    >
                      ...
                      <div className="col-md-9 mb-3">
                        <input
                          ...
                          placeholder={t(
                            "Veuillez télécharger le fichier excel"
                          )}

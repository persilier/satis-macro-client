  ...
  return ready ? (
    ...
    >
      <div className="kt-heading kt-heading--md">
        {t("Information sur l'ancien traitement")}
      </div>
      <div className="kt-form__section kt-form__section--first">
        ...
        <div className="kt-wizard-v2__review">
          {claim &&
          claim.oldActiveTreatment &&
          claim.oldActiveTreatment.transferred_to_targeted_institution_at ? (
            <div className="kt-wizard-v2__review-item">
              <div className="kt-wizard-v2__review-title">
          ...
          {claim &&
          claim.oldActiveTreatment &&
          claim.oldActiveTreatment.transferred_to_unit_by ? (
            <div className="kt-wizard-v2__review-item">
              <div className="kt-wizard-v2__review-title">
              ...
              <div className="kt-wizard-v2__review-content">
                ...
                <span className="mx-2">
                  {claim.oldActiveTreatment.transferred_to_unit_by
                    ? claim.oldActiveTreatment.transferred_to_unit_by.identite
                        ?.lastname +
                      "  " +
                      claim.oldActiveTreatment.transferred_to_unit_by.identite
                        ?.firstname
          ...
          {claim &&
          claim.oldActiveTreatment &&
          claim.oldActiveTreatment.transferred_to_unit_at ? (
            <div className="kt-wizard-v2__review-item">
              <div className="kt-wizard-v2__review-title">
                <span style={{ color: "#48465b" }}>
              ...
              <div className="kt-wizard-v2__review-content">
                ...
                <span className="mx-2">
                  {claim.oldActiveTreatment.responsible_unit
                    ? claim.oldActiveTreatment.responsible_unit.name.fr
                    : "-"}
                </span>
                <br />
                <strong>{t("Date de transfert")}:</strong>
          ...
          {claim &&
          claim.oldActiveTreatment &&
          claim.oldActiveTreatment.assigned_to_staff_at ? (
            <div className="kt-wizard-v2__review-item">
              <div className="kt-wizard-v2__review-title">
              ...
              {!claim ? null : (
                <div className="kt-wizard-v2__review-content">
                  <strong>{t("Nom")}:</strong>
                  <span className="mx-2">
                    {claim.oldActiveTreatment.assigned_to_staff_by
                      ? claim.oldActiveTreatment.assigned_to_staff_by.identite
                          ?.lastname +
                        "  " +
                        claim.oldActiveTreatment.assigned_to_staff_by.identite
                          ?.firstname
            ...
            <div className="kt-wizard-v2__review-item">
              ...
              {!claim ? null : (
                <div className="kt-wizard-v2__review-content">
                  <strong>{t("Nom")}:</strong>
                  <span className="mx-2">
                    {claim.oldActiveTreatment.responsible_staff
                      ? claim.oldActiveTreatment.responsible_staff.identite
                          ?.lastname +
                        "  " +
                        claim.oldActiveTreatment.responsible_staff.identite
                          ?.firstname
          ...
          {claim &&
          claim.oldActiveTreatment &&
          claim.oldActiveTreatment.validated_at ? (
            <div className="kt-wizard-v2__review-item">
              <div className="kt-wizard-v2__review-title">
                <span style={{ color: "#48465b" }}>
              ...
              {!claim ? null : (
                <div className="kt-wizard-v2__review-content">
                  <strong>{t("Nom")}:</strong>
                  <span className="mx-2">
                    {claim.oldActiveTreatment.validated_by
                      ? claim.oldActiveTreatment.validated_by.identite
                          ?.lastname +
                        "  " +
                        claim.oldActiveTreatment.validated_by.identite
                          ?.firstname
                  ...
                  {claim.oldActiveTreatment.invalidated_reason ? (
                    <>
                      ...
                      <span className="mx-2">
                        {claim.oldActiveTreatment.validet_at
                          ? formatDateToTimeStampte(
                              claim.oldActiveTreatment.validated_at
                            )
                          : "-"}
                    ...
                    <>
                      ...
                      <span className="mx-2">
                        {claim.oldActiveTreatment.solution_communicated
                          ? claim.oldActiveTreatment.solution_communicated
                          : "-"}
                      </span>
                      <br />
          ...
          {claim &&
          claim.oldActiveTreatment &&
          claim.oldActiveTreatment.satisfaction_measured_at ? (
            <>
              <div className="kt-wizard-v2__review-item">
                <div className="kt-wizard-v2__review-title">
                  <span style={{ color: "#48465b" }}>
                ...
                <div className="kt-wizard-v2__review-content">
                  ...
                  <span className="mx-2">
                    {claim.oldActiveTreatment.is_claimer_satisfied == 1 ? (
                  ...
                  <span className="mx-2">
                    {claim.oldActiveTreatment.unsatisfied_reason
                      ? claim.oldActiveTreatment.unsatisfied_reason
                      : "-"}
                  </span>
                  <br />
              ...
              <div className="kt-wizard-v2__review-item">
                ...
                <div className="kt-wizard-v2__review-content">
                  <strong>{t("Nom")}:</strong>
                  <span className="mx-2">
                    {claim.oldActiveTreatment.satisfaction_measured_by
                      ? claim.oldActiveTreatment.satisfaction_measured_by
                          .identite?.lastname +
                        "  " +
                        claim.oldActiveTreatment.satisfaction_measured_by
                  ...
                  <span className="mx-2">
                    {claim.oldActiveTreatment.satisfaction_measured_by
                      ? claim.oldActiveTreatment.satisfaction_measured_by.unit
                          .name["fr"]
                      : "-"}
                  </span>
                  <br />

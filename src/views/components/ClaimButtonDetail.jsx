                    ...
                    <div className="kt-wizard-v2__review-item">
                        ...
                        {claim && claim.completed_at ? (
                            <div className="kt-wizard-v2__review-item">
                                ...
                                <div className="kt-wizard-v2__review-content">
                                    <strong>Nom:</strong>
                                    <span className="mx-2">{`${(claim.completed_by && claim.completed_by.identite) ? claim.completed_by.identite.firstname+" "+claim.completed_by.identite.lastname : "-"} `}</span><br/>
                                    <strong>Point de service:</strong>
                                    <span className="mx-2">{(claim.completed_by && claim.completed_by.unit) ? claim.completed_by.unit.name["fr"] : "-"}</span><br/>
                                    <strong>Institution:</strong>
                                    <span className="mx-2">{(claim.completed_by && claim.completed_by.institution) ? claim.completed_by.institution.name : "-"}</span><br/>

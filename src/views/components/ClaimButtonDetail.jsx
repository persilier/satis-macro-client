            ...
            <div className="kt-wizard-v2__review-item">
              ...
              {!claim ? null : (
                <div className="kt-wizard-v2__review-content">
                  ...
                  <span className="mx-2">
                    {claim.claim_object &&
                    claim.claim_object.claim_category.name
                      ? claim.claim_object.claim_category.name["fr"]
                      : "-"}
                  </span>
                  <br />
                  <strong>{t("Objet de réclamations")}:</strong>
                  <span className="mx-2">{claim.claim_object.name["fr"]}</span>
                  <br />
                  ...
                  <span className="mx-2">{claim.lieu ? claim.lieu : "-"}</span>
                  <br />
                  {plan === "HUB" && (
                    <>
                      <strong>
                        {t("Relation entretenue avec le réclamant")}:
                      </strong>
                      <span className="mx-2">
                        {claim.relationship
                          ? formatDateToTimeStampte(
                              claim.relationship.name["fr"]
                            )
                          : "-"}
                      </span>
                      <br />
            ...
            <div className="kt-wizard-v2__review-item">
              ...
              {!claim ? null : (
                <div className="kt-wizard-v2__review-content">
                  <strong>{t("Nom")}:</strong>
                  <span className="mx-2">{`${
                    claim.created_by && claim.created_by.identite
                  ...
                  <strong>{t("Point de service")}:</strong>
                  <span className="mx-2">
                    {claim.created_by && claim.created_by.unit
                      ? claim.created_by.unit.name["fr"]
                      : "-"}
                  </span>
                  <br />
                  <strong>{t("Institution")}:</strong>
                  <span className="mx-2">
                    {claim.created_by && claim.created_by.institution
                      ? claim.created_by.institution.name
                      : "-"}
                  </span>
                  <br />
            ...
            {claim && claim.completed_at ? (
              <div className="kt-wizard-v2__review-item">
                ...
                <div className="kt-wizard-v2__review-content">
                  <strong>{t("Nom")}:</strong>
                  <span className="mx-2">{`${
                    claim.completed_by && claim.completed_by.identite
                      ? claim.completed_by.identite.firstname +
                        " " +
                        claim.completed_by.identite.lastname
                      : "-"
                  } `}</span>
                  <br />
                  <strong>{t("Point de service")}:</strong>
                  ...
                  <span className="mx-2">
                    {claim.completed_by && claim.completed_by.unit
                      ? claim.completed_by.unit.name["fr"]
                      : "-"}
                  </span>
                  <br />
                  <strong>{t("Institution")}:</strong>
                  ...
                  <span className="mx-2">
                    {claim.completed_by && claim.completed_by.institution
                      ? claim.completed_by.institution.name
                      : "-"}
                  </span>
                  <br />
                  ...
                  <span className="mx-2">
                    {claim.completed_at
                      ? formatDateToTimeStampte(claim.completed_at)
                      : "-"}
                  </span>
                  <br />
                </div>

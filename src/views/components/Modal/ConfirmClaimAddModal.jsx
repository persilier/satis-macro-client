...
const ConfirmClaimAddModal = (props) => {
  ...
  const onSubmit = (e) => {
    ...
    if (verifyTokenExpire()) {
      axios
        .post(
          props.endPoint.storeKnowingIdentity(props.id),
          ...
          <div className="modal-body">
            <form>
              <div className="kt-portlet__body">
                <FormInformation information={props.message} />
                          ...
                          <div className="form-group row">
                            ...
                            >
                              <label className="kt-checkbox">
                                ...
                                {t("Le client est-il déjà enregistré ?")}
                                <span />
                              </label>
                            </div>
                            ...
                            >
                              <label htmlFor="relationship">
                                {componentData
                                  ...
                                  : ""}{" "}
                                avec l'institution <InputRequire />
                              </label>
                              <Select
                                isClearable
                                placeholder={

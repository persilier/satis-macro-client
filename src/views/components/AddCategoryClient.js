...
const AddCategoryClient = (props) => {
    ...
    const addCatClient = () => {
        ...
        axios({
            method: 'post',
            url: `http://127.0.0.1:8000/category-clients`,
            data: {
                name: name,
                        ...
                        <form>
                            <div className="form-group">
                                ...
                                {institutionData.data ? (
                                    <select name="institution" id="institution" className="form-control"
                                            value={institution}

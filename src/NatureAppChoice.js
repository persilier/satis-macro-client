...
const NatureAppChoice = (props) => {
  const onMakeChoice = (e, choice) => {
    ...
    DeleteConfirmation.fire(chosePlan("SATIS " + choice)).then((result) => {
      if (result.value) {
        axios
          .put(`${appConfig.apiDomaine}/plan`, data)
          .then((response) => {
    ...
    <div className="kt-portlet">
      <div className="kt-portlet__head">
        <div className="kt-portlet__head-label">
          ...
          <h3 className="kt-portlet__head-title">BIENVENUE SUR SATIS 2020</h3>
        </div>
      </div>
            ...
            <div className="row row-no-padding">
              <div className="kt-pricing-3__item col-lg-4">
                <div className="kt-pricing-3__wrapper">
                  ...
                  <span className="kt-pricing-3__price">
                    ...
                    <span className="kt-pricing-3__text">
                      /&nbsp;&nbsp;Par Installation
                    </span>
                  </span>
                  <br />
                  ...
                  <div className="kt-pricing-3__btn">
                    <button
                      onClick={(e) => onMakeChoice(e, "PRO")}
                      type="button"
                      className="btn btn-brand btn-wide btn-upper btn-bold"
                    >
                      Souscrire
                    </button>
                  </div>
              ...
              <div className="kt-pricing-3__item kt-pricing-3__item--focus col-lg-4">
                <div className="kt-pricing-3__wrapper">
                  ...
                  <span className="kt-pricing-3__price">
                    <span className="kt-pricing-3__label kt-font-brand kt-opacity-7">
                      CFA
                    </span>
                    <span className="kt-pricing-3__number kt-font-brand">
                      50.000.000.000
                    </span>
                    <span className="kt-pricing-3__text kt-font-brand kt-opacity-7">
                      /&nbsp;&nbsp;Par Installation
                    </span>
                  </span>
                  <br />
                  ...
                  <div className="kt-pricing-3__btn">
                    <button
                      onClick={(e) => onMakeChoice(e, "MACRO")}
                      type="button"
                      className="btn btn-light btn-wide btn-upper btn-bold"
                    >
                      Souscrire
                    </button>
                  </div>

...
const FilialeInstitutionForm = (props) => {
    ...
    const fetchData = () => {
      axios
        ...
        .then((response) => {
          ...
          setCountry(
            response.data.institution?.country
              ? {
                  label: response.data.institution.country?.name ?? "",
                  value: response.data.institution.country?.id ?? "",
                }
              : null
          );
          setCountries(
  ...
  const onSubmit = (e) => {
    ...
    if (verifyTokenExpire()) {
      axios
        .post(appConfig.apiDomaine + `/my/institutions`, formData)
        .then((response) => {

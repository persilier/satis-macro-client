						...
						<div className="kt-grid__item">
							<a href="/login" className="kt-login__logo">
								...
								<span style={{
									...
									fontSize: "1.5em",
									paddingLeft: "5px"
								}}>{appConfig.version}</span>
							</a>
						</div>
						<div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
							<div className="kt-grid__item kt-grid__item--middle">
								<h3 className="kt-login__title">Bienvenue sur SATIS {appConfig.version}!</h3>
						...
						<div className="kt-grid__item">
							<div className="kt-login__info">
								<div className="kt-login__copyright">
									&copy {appConfig.name + " " + appConfig.version}
								</div>
					...
					<div
						...
						<div className="kt-login__body">
							...
							<div className="kt-login__form">
								...
								<form className="kt-form" action="" noValidate="novalidate" id="kt_login_form"
